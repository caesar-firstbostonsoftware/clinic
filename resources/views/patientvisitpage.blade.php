                                        ...
                                        @foreach($patientxray as $xray)
                                            <tr id="med1">
                                                ...
                                                @else
                                                    ...
                                                    <a href="/xray/pdf/view/{{$xray->id}}" target="_blank" class="btn btn-sm btn-success">Print</a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <a href="/urinalysis/pdf/view/{{$Uri->id}}" target="_blank" class="btn btn-sm btn-success">Print</a>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                        @endforeach
