...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td style="width:50%;"><b style="font-size: 14pt;">CBC</b></td>
            </tr>
    ...
    <table>
        <tbody>
            <tr>
                <td style="width:50%;"><b style="font-size: 14pt;">Differential Count %</b></td>
            </tr>
            <tr>
                <td style="width:5%;"></td>
    ...
    <table>
        <tbody>
            ...
            @else
            <tr>
                <td style="width:25%;"><b style="font-size: 14pt;">Platelet</b> Count :</td>
                <td style="width:25%;text-align: center;"> <i><b>{{$Hematology->platelet_count}}</b></i></td>
                <td style="width:20%;text-align: center;"> N:150-400 <br> T/mm*</td>
            </tr>
            @endif
            @if(!$Hematology->rbc_desc)
            @else
            <tr>
                <td style="width:25%;"><b style="font-size: 14pt;">RBC</b></td>
                <td style="width:25%;text-align: center;"> <i><b>{{$Hematology->rbc_desc}}</b></i></td>
                <td style="width:20%;text-align: center;"> MIL/mm4</td>
            </tr>
            <tr>
                <td style="width:25%;"></td>
                <td style="width:25%;text-align: center;">F4-5.5 M4.5-6.0</td>
    ...
    <table>
        <tbody>
            ...
            @else
            <tr>
                <td style="width:50%;"><b style="font-size: 14pt;">PRO TIME</b></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:20%;text-align: center;"> sec.</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="width:20%;text-align: center;"> 80 - 90</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="width:20%;text-align: center;"> 21 - 31 pg</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="width:20%;text-align: center;"> 33 - 38 %</td>
            </tr>
            @endif
            @endif
        </tbody>
    ...
    <table>
        <tbody>
            ...
            @else
            <tr>
                <td style="width:50%;"> <b>Clotting(Lee & White)</b><br> Time : <i><b>{{$Hematology->clottinglw_time}}</b></i></td>
            ...
            @else
            <tr>
                <td style="width:50%;"> <b>Clotting</b><br> Time : <i><b>{{$Hematology->clotting_time}}</b></i></td>
            ...
            @else
            <tr>
                <td style="width:50%;"> <b>Bleeding(Duke Method)</b><br> Time : <i><b>{{$Hematology->bleedingdm_time}}</b></i></td>
