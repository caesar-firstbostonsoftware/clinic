...
<body>
    <table>
        <tbody>
            <tr><td></td></tr>
            <tr>
                <td style="width:45%;"><h2><i>Chemistry II</i></h2></td>
    ...
    <table>
        <tbody>
            ...
            @else
            <tr>
                <td style="width:50%;"><b style="font-size: 12pt;"> THYROID PANEL</b></td>
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> 0.3 - 4.2 mIU/L</td>
            </tr>
            @endif
            ...
            @else
            <tr>
                <td style="width:50%;"><b style="font-size: 12pt;"> PSA(Protate Specific Antigen)</b></td>
                <td style="text-align:center;width:25%;">  {{$SecondChemistry->psa}}</td>
                <td style="text-align:center;width:25%;font-size: 7pt;"> < 4ng/mL</td>
            </tr>
            @endif
            ...
            @else
            <tr>
                <td style="width:50%;"><b style="font-size: 12pt;"> LIVER FUNCTION</b></td>
                <td style="width:25%;"></td>
                <td style="width:25%;"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> < 1.1 mg/dl</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> < 0.25 mg/dl</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> < 15.1 - 8.0 g/dl</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> 3.0 - 5.0 g/dl</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> 2.5 - 6.0 g/dl</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="text-align:center;width:25%;font-size: 7pt;"> 1.5-3.0 :1.0 g/dl</td>
            </tr>
            @endif
            @endif
            <tr><td></td></tr>
